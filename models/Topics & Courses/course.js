...
const courseSchema = new mongoose.Schema({
  ...
  slug: {
    en: { type: String, unique: true, lowercase: true, required: true },
    ar: { type: String, unique: true, lowercase: true, required: true },
  },
  thumbnail: {
    type: String,
    required: false,
  ...
  description: {
    ...
    ar: { type: String, required: true, maxlength: 2000 },
  },
  shortDescription: {
